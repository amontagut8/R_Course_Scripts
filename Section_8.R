...
#2 by 3 matrix from the vectors. 
...
#grab a sub-section of mat2 from the previous exercise that looks like:
#[7,8], [12,13]

mat2[2,2:3]
mat2[3,2:3]

#Ex 6: Using indexing notation, grab a sub-section of mat2 from the previous exercise that looks like:
#[19,20], [24,25]
...
#Find out how to use runif() to create 
#4 by 5 matrix consisting of 20 random numbers (4*5=20).
